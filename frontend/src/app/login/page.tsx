...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      login(data.access_token, { id: 0, email });
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0d1117] text-white">
      <div className="w-full max-w-md p-8 rounded-2xl bg-[#161b22] border border-white/10 shadow-2xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2">Operation Europe OS</h1>
          <p className="text-white/60">Log in to your mission control</p>
        </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#161b22] text-white/50">Or continue with</span>
            </div>
          </div>
